...
# Example usage
product_url = 'https://www.sainsburys.co.uk/gol-ui/product/sainsburys-cheese---onion-pizza'
is_product_vegan = is_vegan(product_url)
if is_product_vegan is not None:
    if is_product_vegan:
        print("This product is suitable for vegans.")
    else:
        print("This product is not suitable for vegans or the information is not available.")